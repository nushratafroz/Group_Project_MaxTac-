			            ...
			            <div class="col-8 col-sm-6 col-lg-8">
			             <div class="form-group" id="idno">
				            <div class="col-md-8">
				              ...
				              "Semester">Student ID: </label>
				              <div class="col-md-6">
				                <input class="form-control input-sm" id="idno" name="idno" readonly placeholder=
									  "Student ID" type="text" value="<?php echo (isset($cur)) ? $cur->IDNO : 'ID' ;?>">
								</div>	  
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <select class="form-control input-sm" name="ay" id="ay">
									...
									<option value="2019-2020">2011-2022</option>	
									<option value="2019-2020">2012-2023</option>	
									<option value="2019-2020">2013-2024</option>	
								</select>	
				              </div>
				            </div>
				          </div>
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                 <select class="form-control input-sm" name="Semester" id="Semester">
									<option value="First">Autumn</option>
									<option value="Second">Spring</option>	
